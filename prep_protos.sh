...
#    Description:    Strips out features of the Jarvis protos that do not work in C#
#    Assumptions:    The script assumes you've cloned the jarvis repo alongside
